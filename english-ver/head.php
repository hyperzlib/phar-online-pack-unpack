...
<html><head lang="zh"><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    <title>MC Tech League——<?php echo $page['title'];?></title>
	<meta name="keywords" content="mc技术联盟,MCLeague,PM Toolbox">
	<meta name="description" content="phar pack/unpack" />
    ...
    <div class="navbar navbar-inverse">
      <div class="container clearfix">
        <div class="navbar-header">
          <button class="navbar-toggle active" type="button" data-toggle="collapse" data-target=".navbar-collapse">
        ...
        <nav class="navbar-collapse collapse">
			<ul id="menu-navbar" class="nav navbar-nav">
				<li id="nvabar-item-index" class="active"><a href=".">Index</a></li>
                <li id="nvabar-item-index"><a href="http://mcleague.xicp.net/">Forum</a></li>
				<li id="nvabar-item-index"><a href="http://mcleague.xicp.net/">Other Tools</a></li>
			</ul>
		</nav>
      </div>
    </div>
